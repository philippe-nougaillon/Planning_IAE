...
class EvaluationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluation" do
    assert_difference("Evaluation.count") do
      post evaluations_url, params: { evaluation: { etudiant_id: @evaluation.etudiant_id, note: @evaluation.note } }
    end
  ...
  test "should update evaluation" do
    patch evaluation_url(@evaluation), params: { evaluation: { etudiant_id: @evaluation.etudiant_id, note: @evaluation.note } }
