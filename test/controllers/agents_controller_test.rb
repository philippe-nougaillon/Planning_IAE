...
class AgentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agent" do
    assert_difference('Agent.count') do
      post agents_url, params: { agent: { catégorie: @agent.catégorie, nom: @agent.nom, prénom: @agent.prénom } }
    end
  ...
  test "should update agent" do
    patch agent_url(@agent), params: { agent: { catégorie: @agent.catégorie, nom: @agent.nom, prénom: @agent.prénom } }
