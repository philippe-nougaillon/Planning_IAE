class EtatLiquidatifCollectifToXls < ApplicationService
  require 'spreadsheet'
  include ActionView::Helpers::NumberHelper
  attr_reader :cours

  def initialize(cours, intervenants, start_date, end_date)
    @cours = cours
  ...
  def call    
    ...
    sheet.row(4).concat ['Type','Intervenant','Date','Heure','Formation','Code','Intitulé','Etat','Commentaires',
