class ExportPdf
    ...
    def export_etats_de_services(cours, intervenants, start_date, end_date)
        ...
        font_size 10
        text "Décrets 87-889 du 29/10/1987 et 88-994 du 18/10/88 - CAR du 21/09/2021"
    ...
    def export_vacations_administratives(examens, start_date, end_date, surveillant)
        ...
        font_size 10
        text "Arrêté du 19 avril 2022 relatif au relèvement du salaire minimum de croissance"
        move_down @margin_down
        ...
        taux_horaire = 10.85
        data += [[nil, nil,
                    "Taux horaire en vigueur au 01/05/2022 :", 
                    "#{ taux_horaire } €",
                    nil,
                    "<b>Total brut :</b>",
