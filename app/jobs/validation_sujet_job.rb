class ValidationSujetJob < ApplicationJob
    ...
    def perform(sujet, user_id = 0)
        ...
        mail_log = MailLog.create(user_id: user_id, message_id: mailer_response.message_id, to: examen.intervenant_binome.email, subject: "Validation Sujet Examen", title: title)
