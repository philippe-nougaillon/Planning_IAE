...
salle_3_1 = Salle.create(nom: "3.1", bloc: "P", places: 25)
salle_3_2 = Salle.create(nom: "3.2", bloc: "P", places: 25)
# salle_3_a = Salle.create(nom: "3.A", bloc: "P", places: 5, privée: true)
# salle_3_b = Salle.create(nom: "3.B", bloc: "P", places: 5, privée: true)
# salle_3_c = Salle.create(nom: "3.C", bloc: "P", places: 3, privée: true)
